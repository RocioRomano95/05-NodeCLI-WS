...
// Creemos una función que retorne un objeto  arregloInvitados = ['Facu', 'Santi', 'Toni', 'Guille', 'Solano', 'Leo']
 con las propiedades descriptas más
// abajo, ¿porque usaríamos clousures para esto? porque no esta permitido guardar
// nada mas que esos métodos.
// ¿Podríamos generar un entorno cerrado del  arregloInvitados = ['Facu', 'Santi', 'Toni', 'Guille', 'Solano', 'Leo']
 cual leer y modificar información?
